...
#define UNITY_TINY_WITHOUT_DEBUGGER (UNITY_TINY && !IL2CPP_MONO_DEBUGGER)
#define UNITY_TINY_DEBUGGER (UNITY_TINY && IL2CPP_MONO_DEBUGGER)

#define IL2CPP_UNITY_TINY_SUPPORT_THREADS UNITY_TINY && UNITY_TINY_DEBUGGER
#define IL2CPP_UNITY_TINY_SUPPORT_SOCKETS UNITY_TINY && UNITY_TINY_DEBUGGER

#ifndef IL2CPP_SUPPORT_THREADS
#define IL2CPP_SUPPORT_THREADS (!IL2CPP_TARGET_JAVASCRIPT && (!UNITY_TINY || IL2CPP_UNITY_TINY_SUPPORT_THREADS))
#endif

#ifndef IL2CPP_SUPPORT_SOCKETS
#define IL2CPP_SUPPORT_SOCKETS (!UNITY_TINY || IL2CPP_UNITY_TINY_SUPPORT_SOCKETS)
#endif
