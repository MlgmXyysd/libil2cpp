...
DEFINE_SIMPLE_PROP_INIT(TypeInfo*, WriteTypeId, ReadType);
DEFINE_SIMPLE_PROP_INIT(MethodInfo*, WriteMethodId, ReadMethod);
...
DEFINE_LIST_PROP(TypeInfo*, WriteTypeId, ReadType);
DEFINE_LIST_PROP(MethodInfo*, WriteMethodId, ReadMethod);
...
DEFINE_SET_PROP(TypeInfo*, WriteTypeId, ReadType);
DEFINE_SET_PROP(MethodInfo*, WriteMethodId, ReadMethod);
